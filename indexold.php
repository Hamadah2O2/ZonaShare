              ...
              while ($data = $stm->fetch_array()) { ?>
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="./aksi?act=hapus&id=<?= $data[0] ?>" class="btn btn-danger" onclick="return myFunction('apakah kamu yakin menghapus file ini?')" data-bs-toggle="tooltip" title="Hapus">
                      <i class="bi-trash" style="font-size: 15px;"></i>
                    </a>
                    <a href="./aksi?shareit&id=<?= $data[0] ?>" class="btn <?= ($data['globaly'] >= 1) ? "btn-success" : "btn-secondary"; ?>" onclick="return myFunction('apakah kamu yakin ingin<?= ($data['globaly'] >= 1) ? ' berhenti' : '' ?> membagikan file <?= $data['nama'] ?>?')" data-bs-toggle="tooltip" title="Bagikan / Berhenti bagikan">
